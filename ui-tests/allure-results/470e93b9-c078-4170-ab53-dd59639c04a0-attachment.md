...
```ts
  ...
  12 |     private taxAmount = () => this.page.getByTestId('cart-tax');
  13 |     private totalAmount = () => this.page.getByTestId('cart-total');
  14 | 
  15 |     async openCart() {
...
> 25 |         const subtotalText = await this.subtotalAmount().textContent();
  ...
  27 |         const expectedTax = Number((subtotalValue * 0.085).toFixed(2));
  28 |         const expectedTotal = Number((subtotalValue + expectedTax).toFixed(2));
  29 | 
