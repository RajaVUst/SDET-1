...
```ts
  ...
  26 | 
  27 |         await expect(this.page.getByText(/tax/i)).toBeVisible();
> 28 |         await expect(this.page.getByText(`$${expectedTax.toFixed(2)}`)).toBeVisible();
     |                                                                         ^ Error: expect(locator).toBeVisible() failed
  29 |         await expect(this.page.getByText(/total/i)).toBeVisible();
  30 |         await expect(this.page.getByText(`$${expectedTotal.toFixed(2)}`)).toBeVisible();
  31 |     }
  32 | }
```