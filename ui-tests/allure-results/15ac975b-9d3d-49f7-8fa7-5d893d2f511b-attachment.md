...
Locator: getByText('Payment')
Expected: visible
Error: strict mode violation: getByText('Payment') resolved to 6 elements:
    1) <h1 class="text-2xl font-bold text-gray-900 mb-6">Payment</h1> aka getByRole('heading', { name: 'Payment', exact: true })
    2) <span class="font-bold text-blue-700 border-b-2 border-blue-700 pb-1">2. Payment</span> aka getByTestId('payment-steps').getByText('Payment')
    3) <span class="capitalize font-medium text-amber-900">✓ Payment Success</span> aka getByText('✓ Payment Success')
    4) <span class="capitalize font-medium text-amber-900">✗ Payment Failure</span> aka getByText('✗ Payment Failure')
    5) <h2 class="font-bold text-gray-900">Secure Payment</h2> aka getByRole('heading', { name: 'Secure Payment' })
    6) <p class="text-xs leading-relaxed">Demo e-commerce site for QA automation practice. …</p> aka getByText('Demo e-commerce site for QA')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Payment')
          ...
          - generic [ref=e51]:
            ...
            - generic [ref=e58]:
              ...
              - generic [ref=e62]:
                ...
                - textbox "1234 5678 9012 3456" [ref=e64]
              - generic [ref=e65]:
                - generic [ref=e66]:
                  - generic [ref=e67]: Expiry (MM/YY) *
                  - textbox "MM/YY" [ref=e68]
                - generic [ref=e69]:
                  - generic [ref=e70]: CVV *
                  - textbox "123" [ref=e71]
