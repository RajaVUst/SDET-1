...
```
Error: locator.pressSequentially: Error: strict mode violation: getByPlaceholder('123') resolved to 2 elements:
...
> 41 |         await this.cvvInput().pressSequentially(payment.cvv);
     |                               ^ Error: locator.pressSequentially: Error: strict mode violation: getByPlaceholder('123') resolved to 2 elements:
  42 |     }
  43 | 
